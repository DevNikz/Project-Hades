                        ...
                        if (shader.hasSource) {
                            ...
                            if (GUILayout.Button(new GUIContent("Open", "Open the shader with the system default editor."), EditorStyles.miniButton)) {
                                if (shader.isShaderGraph) {
                                    Shader theShader = AssetDatabase.LoadAssetAtPath<Shader>(shader.path);
                                    AssetDatabase.OpenAsset(theShader);
                                }
                                else {
                            ...
                            if (shader.hasSource) {
                                ...
                                if (prevState != keyword.enabled) {
                                    if (shader.isShaderGraph) {
                                        ...
                                        EditorUtility.DisplayDialog("Shader Graph", "Shader graph doesn't support disabling keywords. Use the Build View to exclude keywords from this shader graph.", "Ok");
                                    }
                                    else {
